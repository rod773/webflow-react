...
const scripts = [
  ...
  {
    type: 'src',
    body: 'D:\\ajax.googleapis.com\\ajax\\libs\\webfont\\1.6.26\\webfont.js',
    isAsync: false,
  },
  {
    type: 'code',
    body: 'WebFont.load({google:{families:["Montserrat:100,100italic,200,200italic,300,300italic,400,400italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic"]}});',
    isAsync: false,
  },
  {
    type: 'code',
  ...
  {
    type: 'code',
    body: 'window.__WEBFLOW_CURRENCY_SETTINGS={currencyCode:"USD",symbol:"$",decimal:".",fractionDigits:2,group:",",template:\'{{wf {"path":"symbol","type":"PlainText"} }} {{wf {"path":"amount","type":"CommercePrice"} }} {{wf {"path":"currencyCode","type":"PlainText"} }}\',hideDecimalForWholeNumbers:!1};',
    isAsync: false,
  },
]
